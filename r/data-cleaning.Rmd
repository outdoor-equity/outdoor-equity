...
plot_histogram_booking_window <- 
    ...
    geom_histogram(fill = "goldendrod") +
    geom_histogram(fill = "goldenrod", binwidth = 10) +
    geom_density() +
    xlim(0, 500) +
    ylim(0, 100000) +
    labs(y = "Individual Visits",
         x = "Days elapsed from order to visit (booking window in days)",
         title = "Booking Window for Reservable Overnight Sites in California for 2018 ") +
    theme_minimal() +
    geom_vline(xintercept = 0, size = .25) +
    geom_vline(xintercept = 30, linetype = "dashed", size = .3, alpha = .5) +
    annotate("text", x = 40, y = 90900, label = "1") +
    geom_vline(xintercept = 60, linetype = "dashed", size = .3, alpha = .5) +
    annotate("text", x = 70, y = 90900, label = "2") +
    geom_vline(xintercept = 90, linetype = "dashed", size = .3, alpha = .5) +
    annotate("text", x = 100, y = 90900, label = "3") +
    geom_vline(xintercept = 120, linetype = "dashed", size = .3, alpha = .5) +
    annotate("text", x = 130, y = 90900, label = "4") +
    geom_vline(xintercept = 150, linetype = "dashed", size = .3, alpha = .5) +
    annotate("text", x = 160, y = 90900, label = "5") +
    geom_vline(xintercept = 180, linetype = "dashed", size = .3, alpha = .5) +
    annotate("text", x = 224, y = 90900, label = "6 months") +
    geom_vline(xintercept = 360, linetype = "dashed", size = .3, alpha = .5) +
    annotate("text", x = 388, y = 90900, label = "1 year")
```
### Agency viz
