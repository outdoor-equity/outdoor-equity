...
## RACE ##
acs_2019_race <- get_acs(geography = "zcta",
                         year = 2019,
                         variables = c(
...
acs_2019_transportation <- get_acs(geography = "zcta",
                                   year = 2019,
                                   variables = c(
...
acs_2019_education <- get_acs(geography = "zcta",
                              year = 2019,
                              variables = c(
...
acs_2019_total_income <- get_acs(geography = "zcta",
                                   year = 2019,
                                   variables = c(
...
acs_2019_median_income <- get_acs(geography = "zcta",
                                  year = 2019,
                                  variables = c(
...
acs_2019_percapita_income <- get_acs(geography = "zcta",
                                     year = 2019,
                                     variables = c(                        
