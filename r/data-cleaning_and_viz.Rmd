...
```{r, eval=FALSE}
ggsave(plot = plot_histogram_booking_window, filename = "../figs/2018_histogram_booking_window.png")
```
...
plot1 <- 
    ...
    geom_point(aes(x = cost_per_visitor_per_day,
                   y = asian), col = "darkgreen") +
    scale_y_continuous(limits = c(0, 1)) +
    labs(x = "Daily cost per visitor (US $)", 
         y = "Proportion",
         title = "Asian") +
    geom_violin(aes(x = cost_per_visitor_per_day,
                   y = asian),
                alpha = .5)
...
plots_race_cost_pervisitor_perday <- (plot1 + plot2 ) / (plot3 + plot4) + plot_annotation(title = "Daily Cost per Visitor Compared to Racial Breakdown of Home ZIP Code \nfor Reservable Overnight Sites in California in 2018")
...
plot_jitter_violin_agency_length_of_stay <- 
    ...
    geom_violin(aes(x = agency,
                ...
                alpha = .5) +
    theme_minimal() +
    labs(x = "Federal Public Land Management Agencies",
         y = "Length of Stay (days)",
         color = "Agency",
         title = "Length of Stay by Agency \nfor Reservable Overnight Sites in California in 2018") +
    scale_color_discrete(labels = c("Bureau of Reclamation", "National Park Service", "US Army Corps of Engineers", "US Foreset Service"))
