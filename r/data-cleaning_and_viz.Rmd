...
raw_data_file_path <- here::here("../../../data_raw/")
```
...
ca_county_geom <- st_read(paste0(raw_data_file_path, "ca_county_geometries/counties.shp")) %>% 
  clean_names() %>% 
...
# census_api <- source("private/census_api.R")
...
plots_race_cost_pervisitor_perday <- (plot_asian + plot_black + plot_native_american) / 
  (plot_white_hispanic_latinx + plot_other + plot_multiracial) #+ 
