...
```{r, include=FALSE}
data_plot_bar_race_ridb_ca <- data_plot_bar_race %>% 
...
# plot for shiny app
plot_col_race_ridb_ca_us <- 
  ggplot(data = data_plot_bar_race_ridb_ca) +
  ...
  labs(x = "Average percentage of race (%)",
       ...
       # caption = "A bar ending in blue indicates the racial group has more representation \nin the reservation data (visitors' home ZIP codes) and ending in red \nindicates the racial group has more representation within California \nresidents."
       ) +
  theme_minimal() +
  theme(plot.background = element_rect("white"),
        ...
        # plot.caption = element_text(vjust = 70)
        ) +
...
ggsave(plot = plot_bar_race_diff_combined, filename = "../figs/plot_bar_race_diff.png", 
       width = 16, height = 14)
ggsave(plot = plot_col_race_ridb_ca_us, filename = "../figs/plot_col_race_ridb_ca_overlay.png",
       width = 22, height = 10)
```
