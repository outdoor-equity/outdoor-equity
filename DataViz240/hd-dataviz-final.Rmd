...
saveRDS(data_combined_2018_clean, "/capstone/outdoorequity/halina/outdoor-equity/shiny/outdoor-equity-app/data/data_resMedIncome_CAmap_2018.rds")
```


## write `zip_geometries_ca` as a csv
```{r}
saveRDS(zip_geometries_ca, "/capstone/outdoorequity/halina/outdoor-equity/shiny/outdoor-equity-app/data/data_zip_geometries_ca.rds")
```
...
tm_shape(data_combined_2018_clean) +
  ...
  tm_symbols(size = "count",
             ...
             popup.vars = c("Agency" = "agency",
                            ...
                            "Estimated Median Household Income" = "mean_median_income"))
