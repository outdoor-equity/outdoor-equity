...
#' About examples: CA ZIP Code Visitorshed Map
#'
...
#'
#' @examples
not_reactive_ca_zip_code_visitorshed_map <- function(site, 
                                        ridb_df, 
                                        zip_geometries_df, 
                                        ca_cities_df){
  
  ## -- data wrangle -- ##
  # dataframe of number of reservations per state
  data <- ridb_df %>% 
    select(agency, admin_unit, park, customer_zip, 
