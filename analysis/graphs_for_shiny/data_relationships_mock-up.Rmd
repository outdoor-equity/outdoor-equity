...
plot_education_distance_traveled <- ggplot(data = data_plot_education_distance_traveled, 
  ...
  geom_point(aes(x = mean_distance_traveled_mi,
                 ...
                 text = paste("Those who live in ZIP codes with high rates <br>an educational level of", 
...
plot_education_site_type <- ggplot(data = data_plot_education_site_type, 
                              aes(x = percent_n,
                                  ...
                                  text = paste0("Of visits to ", aggregated_site_type, " sites, ", scales::percent(percent_n, accuracy = 0.01),
                                                " of reservations were made by <br>people who live in ZIP codes with high education levels of ", 
                                                education))) +
  geom_col(position = "stack") +
  scale_fill_manual(values = edu_group_colors) +
  scale_x_continuous(labels = scales::percent) +
