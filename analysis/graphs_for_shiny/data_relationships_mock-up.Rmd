...
plot_language_site_type <- ggplot(data = data_plot_language_site_type, 
  ...
  labs(x = paste("Percent of Total Reservations per Site Type Group"),
       y = "",
       title = paste0("Percentage of Reservations to Sites by <br>Language Spoekn at Home")) + 
  theme_minimal() +
  theme(plot.background = element_rect("white"),
        panel.grid.major.y = element_blank(),
        panel.grid.major.x = element_blank(),
...
print(paste0("Speak Only English at Home: ", round(top_quartile_ca_language_english_only, 4)*100, " - ", round(max_language_ridb_english_only, 4) *100, "%"))
             
print(paste0("Language(s) Other than English: ", round(top_quartile_ca_language_not_english_only, 4)*100, " - ", round(max_language_ridb_not_english_only, 4) *100, "%"))
```
