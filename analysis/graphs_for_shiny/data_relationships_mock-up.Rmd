...
plot_race_distance_traveled <- ggplot(data = data_plot_race_distance_traveled, 
  ...
  geom_point(aes(x = mean_distance_traveled_mi,
                 ...
                 text = paste("People who live in ZIP codes with high", str_to_title(race), "populations",
...
ggplot(data = data_plot_race_site_type, 
       aes(x = percent_n,
...
plot_race_site_type <- ggplot(data = data, 
                                      aes(x = percent_n,
