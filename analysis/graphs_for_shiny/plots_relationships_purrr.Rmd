...
ggplotly(plot_race_length_of_stay,
         tooltip = list("text")) %>%
  config(modeBarButtonsToRemove = list("pan", "select", "lasso2d", "autoScale2d", 
                                       "hoverClosestCartesian", "hoverCompareCartesian")) %>% 
  add_annotations(text = "Reservations from ZIP codes<br>with high proportions of:", 
...
```{r}
## -- create function to make plot df -- ##
function_plot_education_bookWindow <- function(education_group, weighted_quartile,
                                        ridb_df = data_ridb_acs_2018){
...
```{r}
## -- run function through purrr -- ##
data_plot_education_bookWindow <- 
  data_education_quants %>% 
  pmap_dfr(function_plot_education_bookWindow)
...
# plotly
plot_education_booking_window <- ggplot(data = data_plot_education_bookWindow, 
                                      aes(x = median_booking_window,
                                          y = education_y_lab)) +
  geom_segment(aes(xend = 0, yend = education_y_lab)) +
  ...
  scale_fill_manual(values = education_group_colors) +
  scale_color_manual(values = education_group_colors) +
  labs(x = "Estimated Number of Days in Advance Site is Reserved (days)",
       y = "") + 
  theme_minimal() +
  theme(plot.background = element_rect("white"),
        panel.grid.major.y = element_blank(),
...
data_plot_top_language_reservations <- 
  ...
  mutate(language = str_to_lower(language),
         language = str_replace(string = language,
                                pattern = "english",
                                replacement = "English"),
         language_y_axis = case_when(language == "speak only English at home" ~ "People Who Speak Only<br>English At Home",
...
# plotly
plot_language_distance_traveled <- ggplot(data = data_plot_language_distanceTravel, 
                                      aes(x = median_distance_traveled_mi,
                                          y = language_y_lab)) +
...
```{r}
## -- create function to make plot df -- ##
function_plot_language_bookingWindow <- function(language_group, weighted_quartile,
                                              ridb_df = data_ridb_acs_2018){
...
```{r}
## -- run function through purrr -- ##
data_plot_language_bookingWindow <- 
  data_language_quants %>% 
  pmap_dfr(function_plot_language_bookingWindow)
...
# plotly
plot_language_booking_window <- ggplot(data = data_plot_language_bookingWindow, 
                                      aes(x = median_booking_window,
                                          y = language_y_lab)) +
  geom_segment(aes(xend = 0, yend = language_y_lab)) +
  geom_point(aes(color = language_y_lab, fill = language_y_lab,
...
```{r}
## -- create function to make plot df -- ##
function_plot_language_dailyCost <- function(language_group, weighted_quartile,
                                              ridb_df = data_ridb_acs_2018){
...
```{r}
## -- run function through purrr -- ##
data_plot_language_dailyCost <- 
  data_language_quants %>% 
  pmap_dfr(function_plot_language_dailyCost)
...
# plotly
plot_language_dailyCost <- ggplot(data = data_plot_language_dailyCost, 
                                      aes(x = median_daily_cost,
                                          y = language_y_lab)) +
  geom_segment(aes(xend = 0, yend = language_y_lab)) +
  geom_point(aes(color = language_y_lab, fill = language_y_lab,
...
ggplotly(plot_language_dailyCost,
         tooltip = list("text")) %>%
  config(modeBarButtonsToRemove = list("pan", "select", "lasso2d", "autoScale2d", 
                                       "hoverClosestCartesian", "hoverCompareCartesian")) %>% 
  layout(title = list(text = paste0('<b>', siteInput, '<br>', admin_unitInput, '</b>',
...
### Language x daily cost per person

```{r}
## -- create function to make plot df -- ##
function_plot_language_dailyCostPerPerson <- function(language_group, weighted_quartile,
                                              ridb_df = data_ridb_acs_2018){
...
```{r}
## -- run function through purrr -- ##
data_plot_language_dailyCostPerPerson <- 
  data_language_quants %>% 
  pmap_dfr(function_plot_language_dailyCostPerPerson)
...
# plotly
plot_language_dailyCostPerPerson <- ggplot(data = data_plot_language_dailyCostPerPerson, 
                                      aes(x = median_daily_cost_per_visitor,
                                          y = language_y_lab)) +
  geom_segment(aes(xend = 0, yend = language_y_lab)) +
  geom_point(aes(color = language_y_lab, fill = language_y_lab,
...
ggplotly(plot_language_dailyCostPerPerson,
         tooltip = list("text")) %>%
  config(modeBarButtonsToRemove = list("pan", "select", "lasso2d", "autoScale2d", 
                                       "hoverClosestCartesian", "hoverCompareCartesian")) %>% 
  layout(title = list(text = paste0('<b>', siteInput, '<br>', admin_unitInput, '</b>',
...
```{r}
## -- create function to make plot df -- ##
function_plot_language_lengthStay <- function(language_group, weighted_quartile,
                                              ridb_df = data_ridb_acs_2018){
...
```{r}
## -- run function through purrr -- ##
data_plot_language_lengthStay <- 
  data_language_quants %>% 
  pmap_dfr(function_plot_language_lengthStay)
...
# plotly
plot_language_length_of_stay <- ggplot(data = data_plot_language_lengthStay, 
                                      aes(x = median_length_of_stay,
                                          y = language_y_lab)) +
  geom_segment(aes(xend = 0, yend = language_y_lab)) +
  geom_point(aes(color = language_y_lab, fill = language_y_lab,
...
```{r }
# create function to get weighted quartile value for each group (in quartile function .R)
function_median_income_binned <- function(acs_df = data_ca_acs_2018){
...
```{r}
## -- create function to make plot df -- ##
function_plot_median_income_distanceTravel <- function(acs_df = data_ca_acs_2018,
                                                       ridb_df = data_ridb_acs_2018){
  
  median_income_binned <- function_median_income_binned(acs_df = acs_df)
...
```{r}
## -- run function -- ##
plot_data_income_distanceTravel <- function_plot_median_income_distanceTravel(acs_df = data_ca_acs_2018,
                                                                              ridb_df = data_ridb_acs_2018)

## -- create plot -- ##

# plotly
plot_income_distance_traveled <- ggplot(data = plot_data_income_distanceTravel, 
                                      aes(x = median_distance_traveled_mi,
...
ggplotly(plot_income_distance_traveled,
         tooltip = list("text")) %>%
  config(modeBarButtonsToRemove = list("pan", "select", "lasso2d", "autoScale2d", 
                                       "hoverClosestCartesian", "hoverCompareCartesian")) %>% 
    layout(title = list(text = paste0('<b>', siteInput, '<br>', admin_unitInput, '</b>',
...
```{r}
## -- create function to make plot df -- ##
function_plot_median_income_siteType <- function(acs_df = data_ca_acs_2018,
                                                 ridb_df = data_ridb_acs_2018,
                                                 site_type_string){
...
plot_data_income_siteType <- function_plot_median_income_siteType(acs_df = data_ca_acs_2018,
                                                                  ridb_df = data_ridb_acs_2018, 
                                                                  site_type_string = site_type_categories[[1]])

## -- create plot -- ##

# plotly
plot_income_site_type <- ggplot(data = plot_data_income_siteType) +
  geom_col(aes(x = count,
               y = median_income_binned,
               fill = median_income_binned,
               text = paste0("Of visits to ", site_type_categories[[1]], " overnight reservable sites, ", 
                             comma(count, accuracy = 1), 
...
ggplotly(plot_income_site_type,
         tooltip = list("text")) %>%
  config(modeBarButtonsToRemove = list("pan", "select", "lasso2d", "autoScale2d", 
                                       "hoverClosestCartesian", "hoverCompareCartesian")) %>% 
    layout(title = list(text = paste0('<b>', siteInput, '<br>', admin_unitInput, '</b>',
...
```{r}
## -- create function to make plot df -- ##
function_plot_median_income_bookWindow <- function(acs_df = data_ca_acs_2018,
                                                       ridb_df = data_ridb_acs_2018){
...
```{r}
## -- run function -- ##
plot_data_income_bookWindow <- function_plot_median_income_bookWindow(acs_df = data_ca_acs_2018,
                                                                              ridb_df = data_ridb_acs_2018)

## -- create plot -- ##

# plotly
plot_income_distance_traveled <- ggplot(data = plot_data_income_bookWindow, 
                                      aes(x = median_booking_window,
                                          y = median_income_binned)) +
  geom_segment(aes(xend = 0, yend = median_income_binned)) +
  geom_point(aes(color = median_income_binned, fill = median_income_binned,
...
```{r}
## -- create function to make plot df -- ##
function_plot_median_income_dailyCost <- function(acs_df = data_ca_acs_2018,
                                                       ridb_df = data_ridb_acs_2018){
...
```{r}
## -- run function -- ##
plot_data_income_dailyCost <- function_plot_median_income_dailyCost(acs_df = data_ca_acs_2018,
                                                                              ridb_df = data_ridb_acs_2018)

## -- create plot -- ##

# plotly
plot_income_daily_cost <- ggplot(data = plot_data_income_dailyCost, 
                                      aes(x = median_daily_cost,
                                          y = median_income_binned)) +
  geom_segment(aes(xend = 0, yend = median_income_binned)) +
  geom_point(aes(color = median_income_binned, fill = median_income_binned,
...
ggplotly(plot_income_daily_cost,
         tooltip = list("text")) %>%
  config(modeBarButtonsToRemove = list("pan", "select", "lasso2d", "autoScale2d", 
                                       "hoverClosestCartesian", "hoverCompareCartesian")) %>% 
    layout(title = list(text = paste0('<b>', siteInput, '<br>', admin_unitInput, '</b>',
...
```{r}
## -- create function to make plot df -- ##
function_plot_median_income_dailyCostPerVisitor <- function(acs_df = data_ca_acs_2018,
                                                       ridb_df = data_ridb_acs_2018){
...
```{r}
## -- run function -- ##
plot_data_income_dailyCostPerVisitor <- function_plot_median_income_dailyCostPerVisitor(acs_df = data_ca_acs_2018,
                                                                              ridb_df = data_ridb_acs_2018)

## -- create plot -- ##

# plotly
plot_income_daily_cost_per_visitor <- ggplot(data = plot_data_income_dailyCostPerVisitor, 
                                      aes(x = median_daily_cost_per_visitor,
                                          y = median_income_binned)) +
  geom_segment(aes(xend = 0, yend = median_income_binned)) +
  geom_point(aes(color = median_income_binned, fill = median_income_binned,
...
ggplotly(plot_income_daily_cost_per_visitor,
         tooltip = list("text")) %>%
  config(modeBarButtonsToRemove = list("pan", "select", "lasso2d", "autoScale2d", 
                                       "hoverClosestCartesian", "hoverCompareCartesian")) %>% 
    layout(title = list(text = paste0('<b>', siteInput, '<br>', admin_unitInput, '</b>',
...
```{r}
## -- create function to make plot df -- ##
function_plot_median_income_lengthStay <- function(acs_df = data_ca_acs_2018,
                                                       ridb_df = data_ridb_acs_2018){
...
```{r}
## -- run function -- ##
plot_data_income_lengthStay <- function_plot_median_income_lengthStay(acs_df = data_ca_acs_2018,
                                                                              ridb_df = data_ridb_acs_2018)

## -- create plot -- ##

# plotly
plot_income_length_of_stay <- ggplot(data = plot_data_income_lengthStay, 
                                      aes(x = median_length_of_stay,
                                          y = median_income_binned)) +
  geom_segment(aes(xend = 0, yend = median_income_binned)) +
  geom_point(aes(color = median_income_binned, fill = median_income_binned,
...
ggplotly(plot_income_length_of_stay,
         tooltip = list("text")) %>%
  config(modeBarButtonsToRemove = list("pan", "select", "lasso2d", "autoScale2d", 
                                       "hoverClosestCartesian", "hoverCompareCartesian")) %>% 
    layout(title = list(text = paste0('<b>', siteInput, '<br>', admin_unitInput, '</b>',
