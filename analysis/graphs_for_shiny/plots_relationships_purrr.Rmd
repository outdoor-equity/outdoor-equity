...
# plotly
plot_education_distance_traveled <- ggplot(data = data_plot_language_bookingWindow, 
                                      aes(x = median_booking_window,
                                          y = language_y_lab)) +
  geom_segment(aes(xend = 0, yend = language_y_lab)) +
  geom_point(aes(color = language_y_lab, fill = language_y_lab,
...
# plotly
plot_education_dailyCost <- ggplot(data = data_plot_language_dailyCost, 
                                      aes(x = median_daily_cost,
                                          y = language_y_lab)) +
  geom_segment(aes(xend = 0, yend = language_y_lab)) +
  geom_point(aes(color = language_y_lab, fill = language_y_lab,
...
ggplotly(plot_education_dailyCost,
         tooltip = list("text")) %>%
  config(modeBarButtonsToRemove = list("pan", "select", "lasso2d", "autoScale2d", 
                                       "hoverClosestCartesian", "hoverCompareCartesian")) %>% 
  layout(title = list(text = paste0('<b>', siteInput, '<br>', admin_unitInput, '</b>',
...
# plotly
plot_education_dailyCostPerPerson <- ggplot(data = data_plot_language_dailyCostPerPerson, 
                                      aes(x = median_daily_cost_per_visitor,
                                          y = language_y_lab)) +
  geom_segment(aes(xend = 0, yend = language_y_lab)) +
  geom_point(aes(color = language_y_lab, fill = language_y_lab,
...
ggplotly(plot_education_dailyCostPerPerson,
         tooltip = list("text")) %>%
  config(modeBarButtonsToRemove = list("pan", "select", "lasso2d", "autoScale2d", 
                                       "hoverClosestCartesian", "hoverCompareCartesian")) %>% 
  layout(title = list(text = paste0('<b>', siteInput, '<br>', admin_unitInput, '</b>',
