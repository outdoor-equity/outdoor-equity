...
plot_language <- ggplot() +
  # geom_bar(data = data_plot_language_ca,
  #          aes(x = not_english_only)) +
  # geom_bar(data = data_plot_language_ridb,
  #          aes(x = not_english_only)) +
  # scale_x_binned() +
  geom_density(data = data_plot_language_ca,
                 aes(x = not_english_only),
                 fill = ca_colors[[2]],
                 col = ca_colors[[1]],
                 binwidth = 0.1,
                 ...
                 alpha = 0.5,
                 position = "identity") +
  geom_density(data = data_plot_language_ridb,
                 aes(x = not_english_only),
                 fill = ridb_colors[[1]],
                 col = ridb_colors[[2]],
                 binwidth = 0.1,
