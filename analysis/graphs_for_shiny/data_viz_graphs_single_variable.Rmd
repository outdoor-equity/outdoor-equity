...
test <- rbind(data_plot_language_ridb, data_plot_language_ca)
...
# parameters
color_ridb_ca <- c("RIDB" = "#009900FF", "CA" = "#666666")
fill_ridb_ca <- c("RIDB" = "#00c000", "CA" = "#848484")
...
plot_median_income <- ggplot() +
  ...
  labs(x = "Median Income ($)",
       y = "",
       title = paste0("Median-incomes for <br>California Residents vs. Visitors to ", 
                      siteInput, ", ", admin_unitInput)) +
  theme_minimal() +
  theme(plot.background = element_rect("white"),
        panel.grid.major.y = element_blank())

plotly(plot_median_income)
plot_median_income
```
