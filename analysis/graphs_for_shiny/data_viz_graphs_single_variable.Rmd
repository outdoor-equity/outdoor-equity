...
data_plot_race <- data_plot_race_ridb %>% 
  ...
  mutate(data_source = factor(data_source, levels = c("RIDB", "CA")),
         tooltip_text = case_when(data_source == "RIDB" ~ "Visitors to California sites live in <br>communities with an estimated ",
                                  data_source == "CA" ~ "California has "),
...
# parameters
groups_colors_ridb_ca <- c("RIDB" = "#009900FF", 
                           "CA" = "#666666")
text_colors_ridb_ca <- c("RIDB" = "#006600", 
                         "CA" = "#282828")
...
plot_race <- 
  ...
  geom_col(aes(x = race_percent_average,
               ...
               fill = data_source,
               text = paste0(tooltip_text, percent(race_percent_average, accuracy = 0.1), " ", race, " populations.")),
           position = "dodge") +
