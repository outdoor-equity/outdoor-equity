...
plot_density_language <- ggplot() +
    geom_density(data = data_plot_density_language_ca,
               aes(x = not_english_only),
               fill = groups_colors_ridb_ca[[2]], 
               col = groups_colors_ridb_ca[[2]],
               alpha = 0.5) +
  geom_density(data = data_plot_density_language_ridb,
               aes(x = not_english_only), 
...
plot_density_transportation <- ggplot() +
    geom_density(data = data_plot_density_transportation_ca,
               aes(x = no_vehicle),
               fill = groups_colors_ridb_ca[[2]], 
               col = groups_colors_ridb_ca[[2]],
               alpha = 0.5) +
  geom_density(data = data_plot_density_transportation_ridb,
               aes(x = no_vehicle), 
                   fill = groups_colors_ridb_ca[[1]], 
               col = groups_colors_ridb_ca[[2]], 
               alpha = 0.5) +
  labs(x = "Percentage (%)",
       ...
       subtitle = "Visitors' home ZIP codes for Overnight Reservations in California \nvs. California Residents") +
  scale_x_continuous(limits = c(0, 10), breaks = seq(0, 10, 1), minor_breaks = seq(0, 10, .5)) +
  theme_minimal() +
  theme(plot.background = element_rect("white"),
        panel.grid.major.y = element_blank(),
        # ## only needed for saving as image
...
plot_density_median_income <- ggplot() +
    geom_density(data = data_plot_density_median_income_ca,
               aes(x = median_income),
               fill = groups_colors_ridb_ca[[2]], 
               col = groups_colors_ridb_ca[[2]],
               alpha = 0.5) +
  geom_density(data = data_plot_density_median_income_ridb,
               aes(x = median_income), 
                   fill = groups_colors_ridb_ca[[1]], 
               col = groups_colors_ridb_ca[[2]], 
               alpha = 0.5) +
