...
```{r}
## -- data wrangle -- ##
data_stat_map_yosemite_upper_pines <- data_ridb_acs_2018 %>% 
...
data_stat_map_yosemite_upper_pines_geometries_us <- 
  state_geometries_us %>% 
  left_join(y = data_stat_map_yosemite_upper_pines,
            by = c("fips" = "zip_fips"))
...
data_int_map_yosemite_upper_pines_zip_geometries_ca <- zip_geometries_ca %>% 
  left_join(data_int_map_yosemite_upper_pines, by = c("zip_code" = "customer_zip")) %>% 
