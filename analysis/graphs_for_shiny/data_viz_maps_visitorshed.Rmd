...
data_map_yosemite_upper_pines_geometries_ca <- zip_geometries_ca %>% 
...
data_map_yosemite_upper_pines_geom <- data_ridb_acs_2018 %>% 
  filter(park == "Upper Pines") %>% 
...
# data_map_yosemite_upper_pines_geometries_us <- zip_geometries_us %>% 
#   left_join(data_map_yosemite_upper_pines, by = c("zip_code" = "customer_zip")) %>% 
#   mutate(number_reservations = ifelse(is.na(number_reservations), 0, number_reservations))
...
tmap_mode("view")
tm_shape(data_map_yosemite_upper_pines_geometries_ca) +
  tm_fill(col = "number_reservations",
          palette = "PuRd",
          style = "jenks",
          n = 10) +
  tm_shape(data_map_yosemite_upper_pines_geom) +
