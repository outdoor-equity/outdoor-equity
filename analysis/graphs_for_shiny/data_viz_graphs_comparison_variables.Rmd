...
test1 <- ggplot(data = data_plot_race_distance_traveled) +
...
test3 <- ggplot(data = data_plot_race_distance_traveled) +
...
for (i in seq_along(plot_data)){
  saveRDS(object = get(plot_data[[i]]),
          file = paste0("../../../../data_clean/2018_data_graphs_2_variable/2018_", 
                        plot_data[[i]],
                        ".rds"))
}
```
