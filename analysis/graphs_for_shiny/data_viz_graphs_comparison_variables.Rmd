...
plot_race_distance_traveled <- ggplot(data = data_plot_race_distance_traveled) +
  ...
  scale_x_discrete(labels = c("1" = "0 - 60.2 miles", "2" = "60.2 - 116.9 miles", 
                              "3" = "116.9 - 180.9 miles", "4" = "180.9 - 299.3 miles", 
                              "5" = "299.3 - 3,613.7 miles")#, 
                   #breaks = c("1", "2", "3", "4", "5")
                   ) +
...
# plot
test_plot_asian <- 
  ggplot(data = test %>% filter(race == "Asian")) +
...
test_plot_black <- 
  ggplot(data = test %>% filter(race == "Black")) +
  geom_boxplot(aes(x = factor(distance_traveled_bins),
                   y = race_percentage * 100, 
                   fill = race),
               varwidth = TRUE, outlier.shape = NA) +
...
test_plot_latinx <- 
  ggplot(data = test %>% filter(race == "Hispanic Latinx")) +
  geom_boxplot(aes(x = factor(distance_traveled_bins),
                   y = race_percentage * 100, 
                   fill = race),
               varwidth = TRUE, outlier.shape = NA) +
...
test_plot_multi <- 
  ggplot(data = test %>% filter(race == "Multiracial")) +
  geom_boxplot(aes(x = factor(distance_traveled_bins),
                   y = race_percentage * 100, 
                   fill = race),
               varwidth = TRUE, outlier.shape = NA) +
...
test_plot_native_amer <- 
  ggplot(data = test %>% filter(race == "Native American")) +
  geom_boxplot(aes(x = factor(distance_traveled_bins),
                   y = race_percentage * 100, 
                   fill = race),
               varwidth = TRUE, outlier.shape = NA) +
...
test_plot_other <- 
  ggplot(data = test %>% filter(race == "Other")) +
  geom_boxplot(aes(x = factor(distance_traveled_bins),
                   y = race_percentage * 100, 
                   fill = race),
               varwidth = TRUE, outlier.shape = NA) +
...
test_plot_pac_islander <- 
  ggplot(data = test %>% filter(race == "Pacific Islander")) +
  geom_boxplot(aes(x = factor(distance_traveled_bins),
                   y = race_percentage * 100, 
                   fill = race),
               varwidth = TRUE, outlier.shape = NA) +
...
test_plot_white <- 
  ggplot(data = test %>% filter(race == "White")) +
  geom_boxplot(aes(x = factor(distance_traveled_bins),
                   y = race_percentage * 100, 
                   fill = race),
               varwidth = TRUE, outlier.shape = NA) +
