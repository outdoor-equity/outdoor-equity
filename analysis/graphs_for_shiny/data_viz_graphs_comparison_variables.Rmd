...
test_race_bins <- data_ridb_acs_2018 %>% 
  ...
  mutate(race = str_replace(string = race,
                            ...
                            replacement = " "),
         race = str_to_title(race)) %>% 
  mutate(race_percent_bins = ntile(race_percentage, 5)) %>% 
...
for (i in seq_along(racial_groups)){
  ...
  df_bins <- quantile(test_race_bins$race_percentage, 
                      prob = seq(0, 1, length = 6), type = 5)
  for (name in seq_along(racial_groups_names)){
    
    assign(paste0("test_race_", racial_groups_names[[i]]), data.frame(df), envir = .GlobalEnv)
    assign(paste0("test_race_bins_breaks_", racial_groups_names[[i]]), data.frame(df_bins), envir = .GlobalEnv)
  }
}
...
ggplot(data = test_race_asian) +
  geom_boxplot(aes(x = factor(race_percent_bins),
                   y = distance_traveled_mi, 
                   fill = race),
               varwidth = TRUE, outlier.shape = NA) +
  scale_fill_manual(values = racial_group_colors) +
  scale_x_discrete(labels = c("1" = paste("0 -", 
                                          round(test_race_bins_breaks_asian[2, 1], 2)), 
                              "2" = paste(round(test_race_bins_breaks_asian[2, 1], 2), "-", 
                                          round(test_race_bins_breaks_asian[3, 1], 2)), 
                              "3" = paste(round(test_race_bins_breaks_asian[3, 1], 2), "-", 
                                          round(test_race_bins_breaks_asian[4, 1], 2), "-", 
                                          round(test_race_bins_breaks_asian[5, 1], 2)), 
                              "5" = paste(round(test_race_bins_breaks_asian[5, 1], 2), "-", 
                                          round(test_race_bins_breaks_asian[6, 1], 2)))) +
  scale_y_continuous(limits = c(0, 2000),
                     breaks = seq(0, 2000, 200),
                     sec.axis = dup_axis()) +
  labs(y = "Distance Traveled (miles)",
       x = "Percentage of Racial Group(%)",
       title = "White",
       subtitle = "Distance Traveled Compared to Racial Breakdown of Home \nfor Overnight Reservations in California") +
  theme_minimal() +
  theme(legend.position = "none",
...
ggplot(data = test_race_black) +
  ...
  scale_fill_manual(values = racial_group_colors) +
  scale_x_discrete(labels = c("1" = paste("0 -", 
                                          round(test_race_bins_breaks_black[2, 1], 2)), 
                              "2" = paste(round(test_race_bins_breaks_black[2, 1], 2), "-", 
                                          round(test_race_bins_breaks_black[3, 1], 2)), 
                              "3" = paste(round(test_race_bins_breaks_black[3, 1], 2), "-", 
                                          round(test_race_bins_breaks_black[4, 1], 2)),
                              "4" = paste(round(test_race_bins_breaks_black[4, 1], 2), "-", 
                                          round(test_race_bins_breaks_black[5, 1], 2)), 
                              "5" = paste(round(test_race_bins_breaks_black[5, 1], 2), "-", 
                                          round(test_race_bins_breaks_black[6, 1], 2)))) +
  scale_y_continuous(limits = c(0, 2000),
                     breaks = seq(0, 2000, 200),
                     sec.axis = dup_axis()) +
  labs(y = "Distance Traveled (miles)",
...
ggplot(data = test_race_hispanic_latinx) +
  ...
  scale_fill_manual(values = racial_group_colors) +
  scale_x_discrete(labels = c("1" = paste("0 -", 
                                          round(test_race_bins_breaks_hispanic_latinx[2, 1], 2)), 
                              "2" = paste(round(test_race_bins_breaks_hispanic_latinx[2, 1], 2), "-", 
                                          round(test_race_bins_breaks_hispanic_latinx[3, 1], 2)), 
                              "3" = paste(round(test_race_bins_breaks_hispanic_latinx[3, 1], 2), "-", 
                                          round(test_race_bins_breaks_hispanic_latinx[4, 1], 2)),
                              "4" = paste(round(test_race_bins_breaks_hispanic_latinx[4, 1], 2), "-", 
                                          round(test_race_bins_breaks_hispanic_latinx[5, 1], 2)), 
                              "5" = paste(round(test_race_bins_breaks_hispanic_latinx[5, 1], 2), "-", 
                                          round(test_race_bins_breaks_hispanic_latinx[6, 1], 2)))) +
  # scale_y_continuous(limits = c(0, 2000),
  #                    breaks = seq(0, 2000, 200),
  #                    sec.axis = dup_axis()) +
  labs(y = "Distance Traveled (miles)",
...
ggplot(data = test_race_multiracial) +
  geom_boxplot(aes(x = factor(race_percent_bins),
               ...
               varwidth = TRUE, outlier.shape = NA) +
  scale_fill_manual(values = racial_group_colors) +
  # scale_x_discrete(labels = c("1" = paste("0 -", round(test_race_bins_breaks_multiracial[[2]], 2)), 
  #                             "2" = paste(round(test_race_bins_breaks_multiracial[2, 1], 2), "-", 
  #                                         round(test_race_bins_breaks_multiracial[3, 1], 2)), 
  #                             "3" = paste(round(test_race_bins_breaks_multiracial[3, 1], 2), "-", 
  #                                         round(test_race_bins_breaks_multiracial[4, 1], 2)),
  #                             "4" = paste(round(test_race_bins_breaks_multiracial[4, 1], 2), "-", 
  #                                         round(test_race_bins_breaks_multiracial[5, 1], 2)), 
  #                             "5" = paste(round(test_race_bins_breaks_multiracial[5, 1], 2), "-", 
  #                                         round(test_race_bins_breaks_multiracial[6, 1], 2)))) +
  # scale_y_continuous(limits = c(0, 2000),
  #                    breaks = seq(0, 2000, 200),
  #                    sec.axis = dup_axis()) +
  labs(y = "Distance Traveled (miles)",
...
ggplot(data = test_race_native_american) +
  ...
  scale_fill_manual(values = racial_group_colors) +
  scale_x_discrete(labels = c("1" = paste("0 -", 
                                          round(test_race_bins_breaks_native_american[2, 1], 2)), 
                              "2" = paste(round(test_race_bins_breaks_native_american[2, 1], 2), "-", 
                                          round(test_race_bins_breaks_native_american[3, 1], 2)), 
                              "3" = paste(round(test_race_bins_breaks_native_american[3, 1], 2), "-", 
                                          round(test_race_bins_breaks_native_american[4, 1], 2)),
                              "4" = paste(round(test_race_bins_breaks_native_american[4, 1], 2), "-", 
                                          round(test_race_bins_breaks_native_american[5, 1], 2)), 
                              "5" = paste(round(test_race_bins_breaks_native_american[5, 1], 2), "-", 
                                          round(test_race_bins_breaks_native_american[6, 1], 2)))) +
  # scale_y_continuous(limits = c(0, 2000),
  #                    breaks = seq(0, 2000, 200),
  #                    sec.axis = dup_axis()) +
  labs(y = "Distance Traveled (miles)",
...
ggplot(data = test_race_other) +
  ...
  scale_fill_manual(values = racial_group_colors) +
  scale_x_discrete(labels = c("1" = paste("0 -", 
                                          round(test_race_bins_breaks_other[2, 1], 2)), 
                              "2" = paste(round(test_race_bins_breaks_other[2, 1], 2), "-", 
                                          round(test_race_bins_breaks_other[3, 1], 2)), 
                              "3" = paste(round(test_race_bins_breaks_other[3, 1], 2), "-", 
                                          round(test_race_bins_breaks_other[4, 1], 2)),
                              "4" = paste(round(test_race_bins_breaks_other[4, 1], 2), "-", 
                                          round(test_race_bins_breaks_other[5, 1], 2)), 
                              "5" = paste(round(test_race_bins_breaks_other[5, 1], 2), "-", 
                                          round(test_race_bins_breaks_other[6, 1], 2)))) +
  # scale_y_continuous(limits = c(0, 2000),
  #                    breaks = seq(0, 2000, 200),
  #                    sec.axis = dup_axis()) +
  labs(y = "Distance Traveled (miles)",
...
ggplot(data = test_race_pacific_islander) +
  ...
  scale_fill_manual(values = racial_group_colors) +
  scale_x_discrete(labels = c("1" = paste("0 -", 
                                          round(test_race_bins_breaks_pacific_islander[2, 1], 2)), 
                              "2" = paste(round(test_race_bins_breaks_pacific_islander[2, 1], 2), "-", 
                                          round(test_race_bins_breaks_pacific_islander[3, 1], 2)), 
                              "3" = paste(round(test_race_bins_breaks_pacific_islander[3, 1], 2), "-", 
                                          round(test_race_bins_breaks_pacific_islander[4, 1], 2)),
                              "4" = paste(round(test_race_bins_breaks_pacific_islander[4, 1], 2), "-", 
                                          round(test_race_bins_breaks_pacific_islander[5, 1], 2)), 
                              "5" = paste(round(test_race_bins_breaks_pacific_islander[5, 1], 2), "-", 
                                          round(test_race_bins_breaks_pacific_islander[6, 1], 2)))) +
  # scale_y_continuous(limits = c(0, 2000),
  #                    breaks = seq(0, 2000, 200),
  #                    sec.axis = dup_axis()) +
  labs(y = "Distance Traveled (miles)",
...
ggplot(data = test_race_white) +
  ...
  scale_fill_manual(values = racial_group_colors) +
  scale_x_discrete(labels = c("1" = paste("0 -", 
                                          round(test_race_bins_breaks_white[2, 1], 2)), 
                              "2" = paste(round(test_race_bins_breaks_white[2, 1], 2), "-", 
                                          round(test_race_bins_breaks_white[3, 1], 2)), 
                              "3" = paste(round(test_race_bins_breaks_white[3, 1], 2), "-", 
                                          round(test_race_bins_breaks_white[4, 1], 2)),
                              "4" = paste(round(test_race_bins_breaks_white[4, 1], 2), "-", 
                                          round(test_race_bins_breaks_white[5, 1], 2)), 
                              "5" = paste(round(test_race_bins_breaks_white[5, 1], 2), "-", 
                                          round(test_race_bins_breaks_white[6, 1], 2)))) +
  # scale_y_continuous(limits = c(0, 2000),
  #                    breaks = seq(0, 2000, 200),
  #                    sec.axis = dup_axis()) +
  labs(y = "Distance Traveled (miles)",
