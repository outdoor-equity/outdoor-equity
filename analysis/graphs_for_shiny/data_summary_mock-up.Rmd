...
x_max <- (round(max(data_plot_distance_traveled_under80th_quant$distance_traveled_mi) / 5) * 5) + 5 # max x rounded to nearest 5
center_bin <- 
  if(max(data_plot_distance_traveled_under80th_quant$distance_traveled_mi) > 100){
    round((max(data_plot_distance_traveled_under80th_quant$distance_traveled_mi) / 10) / 5) * 5
  } else {
    round((max(data_plot_distance_traveled_all$distance_traveled_mi) / 10) / 5) * 5
  }
...
plot_distance_traveled_2 <- 
  ...
  geom_histogram(aes(x = distance_traveled_mi,
                 ...
                 center = center_bin,
                 fill = hist_colors[[1]],
                 # highlight the tallest column (currently breaking)
...
center_bin <- 
  if (max(data_plot_distance_traveled_under80th_quant$distance_traveled_mi) > 100){
    round((max(data_plot_distance_traveled_under80th_quant$distance_traveled_mi) / 10) / 5) * 5
  } else if (max(data_plot_distance_traveled_under80th_quant$distance_traveled_mi) > 10) {
    round((max(data_plot_distance_traveled_all$distance_traveled_mi) / 10) / 5) * 5
  } else {
    round((max(data_plot_distance_traveled_all$distance_traveled_mi)) / 5) * 5
  }
