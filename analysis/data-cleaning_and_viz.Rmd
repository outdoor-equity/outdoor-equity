...
racial_groups <- c("asian", "black", "multiracial", 
                   ...
                   "native_american")
racial_group_colors <- c("darkgreen", "darkblue", "darkmagenta", 
...
plots_histogram_race <- 
  ...
  plot_annotation(title = "Racial Breakdown of Home ZIP Code \nfor Reservable Overnight Sites in California in 2018")
...
plot_bor_white <- 
  ...
  geom_histogram(aes(x = white), fill = "#F8766D") +
  labs(title = "Bureau of Reclamation")
plot_bor_black <- 
  ggplot(combined_data_2018_ridb_acs %>% filter(agency == "BOR")) +
  geom_histogram(aes(x = black), fill = "#F8766D") +
  labs(title = "Bureau of Reclamation")

plot_nps_white <- 
  ggplot(combined_data_2018_ridb_acs %>% filter(agency == "NPS")) +
  geom_histogram(aes(x = white), fill = "#7CAE00") +
  labs(title = "National Park Service")
plot_nps_black <- 
  ggplot(combined_data_2018_ridb_acs %>% filter(agency == "NPS")) +
  geom_histogram(aes(x = black), fill = "#7CAE00") +
  labs(title = "National Park Service")

plot_usfs_white <- 
  ggplot(combined_data_2018_ridb_acs %>% filter(agency == "USFS")) +
  geom_histogram(aes(x = white), fill = "#00BFC4") +
  labs(title = "US Forest Service")
plot_usfs_black <- 
  ggplot(combined_data_2018_ridb_acs %>% filter(agency == "USFS")) +
  geom_histogram(aes(x = black), fill = "#00BFC4") +
  labs(title = "US Forest Service")

plot_usace_white <- 
  ggplot(combined_data_2018_ridb_acs %>% filter(agency == "USACE")) +
  geom_histogram(aes(x = white), fill = "#C77CFF") +
  labs(title = "US Army Corps of Engineers")
plot_usace_black <- 
  ggplot(combined_data_2018_ridb_acs %>% filter(agency == "USACE")) +
  geom_histogram(aes(x = black), fill = "#C77CFF") +
  labs(title = "US Army Corps of Engineers")

plot_histogram_agency_race <- 
...
```{r, eval=FALSE}
ggsave(plot = plot_histogram_agency_race, 
       filename = "../figs/2018_histogram_agency_race.png",
       width = 14,
       height = 7)
```
