...
```{r}
## geometri column causing problems

# test <- read.csv("../../../data_clean/2018_joined_data.csv")
# 
# data_combined_2018_site_summary<- read.csv("../../../data_clean/2018_joined_data_site_summary.csv")
```
...
```{r}
ggplot(data = data_combined_2018) +
  geom_point(aes(x = site_type,
                 y = daily_cost_per_visitor))
```
