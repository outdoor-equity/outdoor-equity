...
```{r}
# read in census data
acs_subset_calculate_race(geography = "zcta", year = 2018, geometry = FALSE, state = NULL)
acs_subset_calculate_median_income(geography = "zcta", year = 2018, geometry = FALSE, state = NULL)
acs_subset_calculate_transportation(geography = "zcta", year = 2018, geometry = FALSE, state = NULL)
acs_subset_calculate_education(geography = "zcta", year = 2018, geometry = FALSE, state = NULL)
```
